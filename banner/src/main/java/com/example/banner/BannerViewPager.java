...
public class BannerViewPager extends ViewPager implements View.OnTouchListener {
    ...
    public class CusViewPagerAdapter<T> extends PagerAdapter {
        public PageHelperListener listener;
        public List<T> list;
        public int layoutid;
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (isSlide) {
                this.listener.getItemView(view, this.list.get(position % this.list.size()), position % this.list.size());
            } else {
                this.listener.getItemView(view, this.list.get(position), position);
            }
    ...
    public interface  BannerVisibilityListener{
         ...
         * 是否可见
         */
        void onBannerVisibility(boolean isVisibility, int position);
    }
    ...
    protected void onWindowVisibilityChanged(int visibility) {
        ...
        if (mBannerVisibilityListener!=null){
            mBannerVisibilityListener.onBannerVisibility(visibility == View.VISIBLE,getCurrentItem());
        }
    }
