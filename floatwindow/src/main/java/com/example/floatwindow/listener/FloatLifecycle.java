...
public class FloatLifecycle extends BroadcastReceiver implements Application.ActivityLifecycleCallbacks {
    ...
    public FloatLifecycle(Context applicationContext, boolean showFlag, Class[] activities, LifecycleListener lifecycleListener) {
        ...
        ((Application) mApplicationContext).registerActivityLifecycleCallbacks(this);
        mApplicationContext.registerReceiver(this, new IntentFilter(Intent.ACTION_CLOSE_SYSTEM_DIALOGS));
    }
    ...
    public void destroy() {
        ((Application) mApplicationContext).unregisterActivityLifecycleCallbacks(this);
    }
